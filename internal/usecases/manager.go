...
type Manager interface {
	...
	Get(ctx context.Context, objId uint, ownerId uint, groups []int32) (entity.Object, error)
	GetAll(ctx context.Context, ownerId uint, groups []int32) ([]entity.Object, error)
}
