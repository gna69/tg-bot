...
Для перехода в любой режим можешь просто воспользоваться меню!`
)
...
`
	GroupsBanner = `
Это режим управления группами!
Тут ты можешь создать группу, добавить в нее своих близких людей и вести список вместе с ними!
В данном режиме можно:
1. Посмотреть группы.
2. Создать группу.
3. Добавить в группу.
